 ...
 */
public class JitsiIQHandler extends IQHandler implements ServerFeaturesProvider
{
    private final static Logger Log = LoggerFactory.getLogger( JitsiIQHandler.class );	
    ...
    public JitsiIQHandler() {
        super("Jitsi IQ Handler");
    }
