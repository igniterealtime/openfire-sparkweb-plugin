...
public class BookmarkManager {
    ...
    /**
     * Returns all URL bookmarks by protocol
     *
     * @return the collection of bookmarks.
     */
    public static Collection<Bookmark> getSpeedDialBookmarks() {
        // TODO: add caching.
        List<Bookmark> bookmarks = new ArrayList<Bookmark>();
        Connection con = null;
        PreparedStatement pstmt = null;
            ...
            while (rs.next()) {
                ...
                try {
                    ...
                    if (bookmark.getType() == Bookmark.Type.url)
                    {
                        ...
                        if (url.indexOf("sip:") == 0 || url.indexOf("tel:") == 0 || url.indexOf("fs:") == 0 || url.indexOf("extn:") == 0 || url.indexOf("user:") == 0)
                        {
                            bookmarks.add(bookmark);
                        }
                    }
